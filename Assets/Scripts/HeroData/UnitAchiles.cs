...
public class UnitAchiles : UnitGamePositive
{
    [SerializeField] private float _rangeSpread;
    [SerializeField] private Transform _spaunSpear;
    [SerializeField] private Arrow _spear;
    ...
    public override void TakeShot(GameObject target)
    {
        ...
        Instantiate(_spear.gameObject, _spaunSpear.position, Quaternion.identity);
    }
}
